...
val macaroni_and_cheese = Color(0x80FFBB7A)
val vulcan = Color(0xFF11111F)
val sunglow = Color(0xFFFFC72C)

val md_theme_light_primary = sunglow
val md_theme_light_onPrimary = vulcan
val md_theme_light_primaryContainer = macaroni_and_cheese
val md_theme_light_onPrimaryContainer = Color(0xFF0E0664)
val md_theme_light_secondary = macaroni_and_cheese
val md_theme_light_onSecondary = Color(0xFFFFFFFF)
val md_theme_light_secondaryContainer = macaroni_and_cheese
...
val md_theme_light_surfaceVariant = Color(0x80FFBB7A)
val md_theme_light_onSurfaceVariant = vulcan
val md_theme_light_outline = vulcan
val md_theme_light_inverseOnSurface = Color(0xFFF3EFF4)
val md_theme_light_inverseSurface = Color(0xFF313034)
val md_theme_light_inversePrimary = macaroni_and_cheese
val md_theme_light_shadow = Color(0xFF000000)
val md_theme_light_surfaceTint = vulcan
